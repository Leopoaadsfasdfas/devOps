...
public class FreshWorksTest {
	...
	@BeforeMethod
	@Parameters({"browser","nombre"})
	public void setup(String browser,String nombre) {
	...
	public void freshWorkslogoTest() {
		boolean flag = false;
			flag = driver.findElement(By.cssSelector("div.col-md-5")).isDisplayed();
	...
	public void getFooterLinksTest() {
		...
		assertEquals(footerLinksList.size(), 32);
